    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col">
            <div class="card-body p-4">
                <form action="{{ route('auth_saleOrder') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="p-5">
                            ...
                            <div class="p-5">
                                ...
                                <div class="mb-2 pb-2">
                                    <select class="select" name="payment_type">
                                        <option value="Cradit/Debit Card">Cradit/Debit Card</option>
                                        <option value="Promt Pay">Promt Pay</option>
                                ...
                                <div class="form-outline">
                                    <input type="text" id="form3Examplea2" class="form-control form-control-lg" name="promotion_code"/>
